package com.vertin_go.activityremotepdfscreenshot;
...
public class RemotePDFActivity extends BaseSampleActivity implements DownloadFile.Listener, View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.remote_pdf_example);
        ...
        String url_pdf = "http://vertin-go.com/Fonctions_Annexes/annexes/pdt-page-de-telechargement/Pdf%20De%20Formation%20Utiles/Traffic%20Hurricane.pdf";

        etPdfUrl.setText(url_pdf);
    ...
    public void findViews() {
        ...
        rootContent = (LinearLayout) findViewById(R.id.remote_pdf_root);
    }
